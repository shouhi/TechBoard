<template>
  <div>
    <h3 class="text-3xl font-medium text-gray-700">Create board</h3>
    <div class="mt-4">
      <div class="mt-4">
        <div
          class="
        ...
        >
          <div
            ...
            "
          >
            <div class="flex items-center justify-center w-12 bg-techuni">
              <svg
            ...
            <div class="px-4 py-2 -mx-3">
              <div class="mx-3">
                <span class="font-semibold text-green-500">New board</span>
