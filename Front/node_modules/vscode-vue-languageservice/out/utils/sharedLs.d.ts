...
export declare function getDummyTsLs(ts: typeof import('typescript/lib/tsserverlibrary'), ts2: typeof import('vscode-typescript-languageservice'), doc: TextDocument, getPreferences: ts2.LanguageServiceHost['getPreferences'], getFormatOptions: ts2.LanguageServiceHost['getFormatOptions']): {
    ls: {
        ...
        doComplete: (uri: string, position: import("vscode-languageserver-protocol").Position, options?: ts.GetCompletionsAtPositionOptions | undefined) => Promise<import("vscode-languageserver-protocol").CompletionItem[]>;
        doCompletionResolve: (item: import("vscode-languageserver-protocol").CompletionItem, newOffset?: number | undefined) => Promise<import("vscode-languageserver-protocol").CompletionItem>;
        ...
        getSelectionRange: (uri: string, position: import("vscode-languageserver-protocol").Position) => import("vscode-languageserver-protocol").SelectionRange | undefined;
        doValidation: (uri: string, options: {
            semantic?: boolean | undefined;
            syntactic?: boolean | undefined;
            suggestion?: boolean | undefined;
            declaration?: boolean | undefined;
        }, cancellationToken?: ts.CancellationToken | undefined) => import("vscode-languageserver-protocol").Diagnostic[];
        getFoldingRanges: (uri: string) => import("vscode-languageserver-protocol").FoldingRange[];
        getDocumentSemanticTokens: (uri: string, range: import("vscode-languageserver-protocol").Range, cancle?: import("vscode-jsonrpc").CancellationToken | undefined) => [number, number, number, number, number][] | undefined;
        callHierarchy: {
        ...
        __internal__: {
            ...
            doCompleteSync: (uri: string, position: import("vscode-languageserver-protocol").Position, options?: ts.GetCompletionsAtPositionOptions | undefined) => import("vscode-languageserver-protocol").CompletionItem[];
        };
    };
    uri: string;
};
