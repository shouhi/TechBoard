...
function register({ sourceFiles, getTsLs, htmlLs, pugLs, modules: { html } }, updateTemplateScripts) {
    ...
    return (uri, range, cancle, resultProgress) => {
        ...
        if (!(cancle === null || cancle === void 0 ? void 0 : cancle.isCancellationRequested) && scriptSetupResult.length) {
