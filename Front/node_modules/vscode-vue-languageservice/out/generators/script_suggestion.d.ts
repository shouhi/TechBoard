...
export declare function generate(script: null | {
    src?: string;
    content: string;
}, scriptSetup: null | {
    content: string;
}, scriptRanges: ScriptRanges | undefined, scriptSetupRanges: ScriptSetupRanges | undefined, htmlGen: ReturnType<typeof templateGen['generate']> | undefined): {
    getText: () => string;
