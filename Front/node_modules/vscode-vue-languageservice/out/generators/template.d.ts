...
import type { TransformContext } from '@vue/compiler-dom';
export declare const transformContext: TransformContext;
export declare function generate(sourceLang: 'html' | 'pug', html: string, componentNames: string[] | undefined, elementNames: string[] | undefined, cssScopedClasses: string[] | undefined, htmlToTemplate: (htmlStart: number, htmlEnd: number) => number | undefined): {
    codeGen: {
        getText: () => string;
